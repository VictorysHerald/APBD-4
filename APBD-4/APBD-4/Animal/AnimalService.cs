...
public class AnimalService : IAnimalService
{
    ...
    public AnimalService()
    {
        ...
        _animals.Add(new Animal("Bob", "Dog", 21, "Black"));
        _animals.Add(new Animal("K", "Cat", 32, "Grey"));
        _animals.Add(new Animal("Maa", "Dog", 2, "Black"));
        _animals.Add(new Animal("Tuna", "Cat", 433, "Grey"));
    }
